// #ifndef PX4_MAP_MANAGER_OCCUPANCY_MAP_HPP
// #define PX4_MAP_MANAGER_OCCUPANCY_MAP_HPP
...
//   // Callbacks
//   void depthCB(const sensor_msgs::msg::Image::ConstSharedPtr img);
//   void poseCB(const geometry_msgs::msg::PoseStamped::ConstSharedPtr pose);
//   void updateOccupancyCB();
// };

// }  // namespace px4_map_manager

// #endif  // PX4_MAP_MANAGER_OCCUPANCY_MAP_HPP
...
#include <px4_map_manager/raycast.hpp>
#include "px4_map_manager/srv/ray_cast.hpp"
#include "px4_map_manager/srv/check_pos_collision.hpp"
#include <thread>
...
namespace px4_map_manager {
	...
	protected:
		...
		// ROS2 subscriptions
		// std::shared_ptr<rclcpp::Subscription<sensor_msgs::msg::Image>> depthSub_;
		// std::shared_ptr<rclcpp::Subscription<sensor_msgs::msg::PointCloud2>> pointcloudSub_;
		// std::shared_ptr<rclcpp::Subscription<geometry_msgs::msg::PoseStamped>> poseSub_;
		// std::shared_ptr<rclcpp::Subscription<nav_msgs::msg::Odometry>> odomSub_;
		// Direct subscription for depth images (not using synchronization)
		rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr directDepthSub_;
		...
		// ROS2 synchronizers
		// typedef rclcpp::sync_policies::ApproximateTime<sensor_msgs::msg::Image, geometry_msgs::msg::PoseStamped> depthPoseSync;
		// std::shared_ptr<rclcpp::Synchronizer<depthPoseSync>> depthPoseSync_;
		// std::shared_ptr<rclcpp::Subscription<nav_msgs::msg::Odometry>> odomSub_;
		// typedef rclcpp::sync_policies::ApproximateTime<sensor_msgs::msg::Image, nav_msgs::msg::Odometry> depthOdomSync;
		// std::shared_ptr<rclcpp::Synchronizer<depthOdomSync>> depthOdomSync_;
		// typedef rclcpp::sync_policies::ApproximateTime<sensor_msgs::msg::PointCloud2, geometry_msgs::msg::PoseStamped> pointcloudPoseSync;
		// std::shared_ptr<rclcpp::Synchronizer<pointcloudPoseSync>> pointcloudPoseSync_;
		// typedef rclcpp::sync_policies::ApproximateTime<sensor_msgs::msg::PointCloud2, nav_msgs::msg::Odometry> pointcloudOdomSync;
		// std::shared_ptr<rclcpp::Synchronizer<pointcloudOdomSync>> pointcloudOdomSync_;	
		...
		rclcpp::Service<px4_map_manager::srv::CheckPosCollision>::SharedPtr collisionCheckServer_;
		rclcpp::Service<px4_map_manager::srv::RayCast>::SharedPtr raycastServer_;
	...
	public:
		...
		occMap();  // Default constructor
		occMap(const rclcpp::NodeOptions & options);  // Constructor with NodeOptions
	  
		virtual ~occMap() = default;
		void initMap(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
		...
		// service
		bool checkCollision(px4_map_manager::srv::CheckPosCollision::Request& req, px4_map_manager::srv::CheckPosCollision::Response& res);		
		bool getRayCast(px4_map_manager::srv::RayCast::Request& req, px4_map_manager::srv::RayCast::Response& res);
		...
		void getCameraPose(const geometry_msgs::msg::PoseStamped::ConstSharedPtr& pose, Eigen::Matrix4d& camPoseMatrix);
		void getCameraPose(const nav_msgs::msg::Odometry::ConstSharedPtr& odom, Eigen::Matrix4d& camPoseMatrix);
	};
	// inline function
	// user function
	...
	inline void occMap::getCameraPose(const geometry_msgs::msg::PoseStamped::ConstSharedPtr& pose, Eigen::Matrix4d& camPoseMatrix){
	...
	inline void occMap::getCameraPose(const nav_msgs::msg::Odometry::ConstSharedPtr& odom, Eigen::Matrix4d& camPoseMatrix){
		Eigen::Quaterniond quat;
